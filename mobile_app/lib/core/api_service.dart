...
class ApiService {
  static const String _defaultIP = '192.168.1.77'; 
  
  static String get baseUrl {
    if (kIsWeb) return 'http://localhost:8000/api/';
    return 'http://$_defaultIP:8000/api/';
  }
  ...
  static Future<http.Response> post(String endpoint, Map<String, dynamic> body, {bool isFleet = false}) async {
    ...
    return await http.post(Uri.parse(url), headers: await _getHeaders(), body: jsonEncode(body));
  }
  ...
  static Future<http.Response> put(String endpoint, Map<String, dynamic> body, {bool isFleet = false}) async {
    return await http.put(Uri.parse('$baseUrl$endpoint'), headers: await _getHeaders(), body: jsonEncode(body));
  }

  static Future<http.Response> patch(String endpoint, Map<String, dynamic> body, {bool isFleet = false}) async {
    return await http.patch(Uri.parse('$baseUrl$endpoint'), headers: await _getHeaders(), body: jsonEncode(body));
  }
